...
class WebViewController: NSObject, ObservableObject {
    ...
    override init() {
        ...
        preferences.setValue(true, forKey: "developerExtrasEnabled") // 启用开发者工具
...
extension WebViewController: WKScriptMessageHandler {
    func userContentController(
        ...
        print("Received RPC request: \(request.method)")

        // 异步处理请求
        Task {
            let response = await rpcHandler.handle(request)
